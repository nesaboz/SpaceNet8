...
# https://github.com/likyoo/Siam-NestedUNet/blob/a60d3d41f0114387c57dcc7cd2de3b6b0f259ad0/models/Models.py#L63

# Kaiyu Li
# https://github.com/likyoo
#

# see paper: https://ieeexplore.ieee.org/document/9355573
...
class SNUNet_ECAM(nn.Module):
    ...
    def __init__(self, num_classes, num_channels, from_pretrained=False):
        ...
        self.conv0_0 = conv_block_nested(num_channels, filters[0], filters[0])
