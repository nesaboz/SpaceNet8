...
class SiamUnet_diff(nn.Module):
    ...
    def __init__(self, num_classes, num_channels, from_pretrained=False):
        ...
        self.input_nbr = num_channels

        self.conv11 = nn.Conv2d(self.input_nbr, filters[0], kernel_size=3, padding=1)
        ...
        self.conv11d = nn.ConvTranspose2d(filters[0], num_classes, kernel_size=3, padding=1)
